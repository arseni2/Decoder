...
function App() {
  ...
  // Функция для очистки текстовых областей
  const clearFields = () => {
    setStr("");
    setHash("");
    setErr("");
        ...
        <div className="flex flex-col gap-4 bg-gray-200 bg-opacity-70 rounded-xl p-8 h-auto max-h-[90vh] overflow-y-auto">
          <div className="flex flex-col gap-1">
            ...
            <div className="flex gap-2 mt-2">
              <button onClick={() => copyToClipboard(str)} className="bg-blue-500 text-white px-4 py-2 rounded">Копировать</button>
              <button onClick={clearFields} className="bg-red-500 text-white px-4 py-2 rounded">Очистить</button>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            ></textarea>
            <div className="flex gap-2 mt-2">
              <button onClick={() => copyToClipboard(hash)} className="bg-blue-500 text-white px-4 py-2 rounded">Копировать</button>
              <button onClick={clearFields} className="bg-red-500 text-white px-4 py-2 rounded">Очистить</button>
            </div>
          </div>
